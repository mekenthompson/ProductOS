...
| **`pm-playbook/`** | Separate human-craft layer for the whole product function (PM, design, marketing, research): the six-phase loop, the judgement system (`craft`, the calibration ledger, customer formulations, formulation reviews), discovery, RICE, personas. It references the OS; the OS crosses back only over the named bridges in `AGENTS.md`. |
