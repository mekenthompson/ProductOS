...
On approval, the commercial mechanism, the [LB] assumptions, and the Confidence score are the prediction the RFC commits to, scored at the 90-day [post-launch review](../product-playbook/templates/post-launch-review.md). Approving an RFC without a scoreable mechanism is an unscored bet.
...
[Discovery](../product-playbook/discovery.md).
